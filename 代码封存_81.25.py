...
from jimm.models import swin_base_patch4_window12_384
import random
import pandas as pd
...
if __name__ == '__main__':
    ...
    parser.add_argument('--modelroot', type=str, default=os.path.join(project_root, 'code/JT/baseline/model_save_1'))
    parser.add_argument('--testonly', action='store_true', default=False)
    parser.add_argument('--loadfrom', type=str, default=os.path.join(project_root, 'checkpoints/checkpoint1.pkl'))
    parser.add_argument('--result_path', type=str, default=os.path.join(project_root, 'code/JT/baseline/result_1.txt'))
    ...
    if not args.testonly:
        optimizer = nn.AdamW(model.parameters(), lr=2e-5, weight_decay=0.05)
